 ...
 */
@Getter
public class CouponOfOrder implements Cloneable{
    ...
    public CouponOfOrder(Long orderId, Long couponId) {
    ...
    @Override
    public CouponOfOrder clone() throws CloneNotSupportedException {
        return ((CouponOfOrder) super.clone());
    }
}
