...
Source Database       : sweetcat_market_store_order

Target Server Type    : MYSQL
Target Server Version : 80021
File Encoding         : 65001

Date: 2022-01-04 18:40:07
*/
...
CREATE TABLE `t_commodity_of_order` (
  ...
  `commodity_pic_small` varchar(1228) DEFAULT NULL COMMENT '鍟嗗搧涓诲浘',
...
-- ----------------------------
-- Table structure for `t_coupon_of_commodity`
-- ----------------------------
DROP TABLE IF EXISTS `t_coupon_of_commodity`;
CREATE TABLE `t_coupon_of_commodity` (
  `order_id` bigint unsigned NOT NULL COMMENT '订单编号',
  `commodity_id` bigint unsigned NOT NULL COMMENT '商品id',
...
-- ----------------------------
-- Records of t_coupon_of_commodity
-- ----------------------------
